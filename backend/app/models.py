...
class Student(db.Model):
    ...
    password_hash = db.Column(db.String(255), nullable=False)  # 存储哈希值
...
class Homework(db.Model):
    ...
    max_score = db.Column(db.Integer, default=100, nullable=False, comment="本次作业分数上限")
    grades_published = db.Column(db.Boolean, default=False, nullable=False, comment="是否已发布成绩")
    create_time = db.Column(db.DateTime, default=datetime.utcnow)
